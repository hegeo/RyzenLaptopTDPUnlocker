...
namespace RyzenTDPUnlocker
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void RunExe()
        {
            ...
            {
                MessageBox.Show("程序目录内找不到ryzenadj.exe\nCan't find ryzenadj.exe folder");
            }
        ...
        public string CreateBat()
        {
            ...
            string batFilePath = $"{propath}\\autostart.bat";
        ...
        private void T_eng_MouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            t_tilite.Content = "Ryzen TDP Unlocker";
